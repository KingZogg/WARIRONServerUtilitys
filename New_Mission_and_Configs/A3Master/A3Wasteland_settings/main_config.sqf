...
AW3_NotOwnerUnlockDuration = 120; //Extend the unlock duration for non owners of objects.
...
A3W_tkKickAmount = 50;			// TeamKill amount needed before Kick.
...
A3W_remoteBombStoreRadius = 25;    // Prevent players from placing remote explosives within this distance from any store (0 = disabled)
A3W_vehiclePurchaseCooldown = 90;  // Number of seconds to wait before allowing someone to purchase another vehicle, don't bother setting it too high because it can be bypassed by rejoining
...
A3W_atmRemoveIfDisabled = 1;       // Remove all ATMs from map if A3W_atmEditorPlacedOnly is set to 0 (0 = no, 1 = yes)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
A3W_resupplyTruck = 1;            //something to do with server/functions/spawnStoreObject.sqf
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
A3W_bountyMissions = 1;
A3W_bountyMissionPlayers = 8; //Mininum Number of players required to start mission.

A3W_patrolMissions = 0;

A3W_mainMissionDelay = 20*60;      // Time in seconds between Main Missions
A3W_mainMissionTimeout = 120*60;    // Time in seconds that a Main Mission will run for, unless completed

A3W_sideMissionDelay = 15*60;       // Time in seconds between Side Missions
...
A3W_goldMissionDelay = 15*60;     // Time in seconds between Gold Missions
A3W_goldMissionTimeout = 180*60;   // Time in seconds that a Gold Mission will run for, unless completed

A3W_bountyMissionDelay = 60*60;
A3W_bountyMissionTimeout = 30*60;

A3W_patrolMissionDelay = 45*60;
A3W_patrolMissionTimeout = 60*60;
/*
A3W_mainMissionDelay = 10*60;      // Time in seconds between Main Missions
A3W_mainMissionTimeout = 180*60;    // Time in seconds that a Main Mission will run for, unless completed
A3W_sideMissionDelay = 15*60;       // Time in seconds between Side Missions
A3W_sideMissionTimeout = 180*60;    // Time in seconds that a Side Mission will run for, unless completed
A3W_moneyMissionDelay = 30*60;     // Time in seconds between Money Missions
A3W_moneyMissionTimeout = 60*60;   // Time in seconds that a Money Mission will run for, unless completed
A3W_goldMissionDelay = 30*60;     // Time in seconds between Gold Missions
A3W_goldMissionTimeout = 360*60;   // Time in seconds that a Gold Mission will run for, unless completed
*/
