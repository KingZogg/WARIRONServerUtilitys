...
/*  Check CTRLs on D12   */ _C12 = true;	/* true or false */	/* *experimental* - will announce BadControls count on IDD 12 or BadControl and a number */
...
/*  Use EH_Fired check   */ _EHF = true;	/* true or false */	/* Epoch only (doesn't load with other mods) */
